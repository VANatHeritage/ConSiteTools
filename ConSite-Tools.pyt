# ----------------------------------------------------------------------------------------
# ConSite-Tools.pyt
# Toolbox version: 2.2.1  # version scheme: major.minor.bugfix
tbx_version = "2.2.1"  # headsup: the toolbox version here is appended to the Toolbox label, which can be viewed in ArcPro (right click toolbox -> Properties).
